...
My daily post comes from the [project in GitHub](https://github.com/users/idisblueflash/projects/3/views/1?layout_template=board).

I will move one card to `In Progress` , you should create a new branch and name it as the topic I'm going to write, then create a PR for this, also link the card I'm working on in project.

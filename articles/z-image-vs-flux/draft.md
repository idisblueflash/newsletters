...
上一篇[Mac mini 生图模型测试](https://ai-companion-newsletter.beehiiv.com/p/mac-mini-image-model-benchmark)写了我测试过多个模型， 这次我把目光集中到胜出的两个模型上，选出我的主力模型。
...
如果你也用 Mac Mini （M4，16GB），下面的参数你会感兴趣：

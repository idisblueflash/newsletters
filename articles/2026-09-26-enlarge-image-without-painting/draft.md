...
![向两边 outpaint 的三步：768×768 方形燕子原图、左右两侧灰色待补区域、拓宽到 1536×768 后左边补出一棵树、右边补出云和更多燕子](swallow-outpaint-image-grid.png)
...
![只向左扩展的 outpaint 失败过程：768×768 原图、左侧灰色待补区域、以及结果平铺出第二个正方形并留下中缝](left-only-outpaint-image-grid.png)

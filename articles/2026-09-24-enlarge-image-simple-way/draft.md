...
![「图：768×768 的方形原图，米黄色背景上剪影风格的燕子群，两根斜向电线上停满燕子，右上角一只燕子展翅飞过」](./assets/images/original-square.jpeg)
...
![「图组：同一区域的局部特写对比，原图 768×768 裁切与放大后 1536×1536 裁切，可见放大后细节更清晰」](./assets/images/size-comparison-grid.jpeg)

剩下的是裁剪出需要的尺寸。

ComfyUI 内建的剪切功能就能做到。写好长宽的参数(1200x630)，运行，就有了。默认的截取从图片左上方开始，我需要调节纵向的位移(y=100)，才能得到满意的效果。

![「图：裁剪成 1200×630 长条封面图后的效果，电线上的燕子群和右上角飞行的燕子都保留在画面里，上下多余的天空被裁掉」](./assets/images/cropped-cover.jpeg)

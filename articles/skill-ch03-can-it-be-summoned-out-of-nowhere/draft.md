...
有人做了650次受控实验，专门测description的写法。结论是：同样的触发词，换一种写法，触发率能从37%跳到94%。也就是说，用被动式写法，每三次只有一次能成功触发；换成指令式，几乎次次都中。
...
被动式触发率低的原因在于，它只描述了用途，没有对 Claude 发出明确的行动指令。Claude 读到那句话，就像你告诉厨师「我想吃肉」，他走到冰箱前，猪肉牛肉羊肉都在，拿起来又放下，最后还是转过身来问你。

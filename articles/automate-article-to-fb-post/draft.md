...
第二天我打开帖子，还是没有看到新的回复。但我发现「自动化」三个字我漏掉了 —— 在问题的正文最后，小艺提到想把这个流程做成自动化的。

上面的步骤已经能让新人把一个社群的文章转换好了，我也贴了社群里别人分享的自动化帖子，但没有细说。

很多新人（包括我这样的老手）想到一个流程的时候，都会幻想着按下一个按钮，那套流程就跑完了。但事实并不是这样。我们看别人 demo 的时候是这样的，但他们在 5 分钟之内没办法把每一个细节讲清楚。你要自己搭的话，还是要一步一步来。

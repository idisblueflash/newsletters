...
很多新人一想到流程，就幻想按一下按钮，整套流程自己跑完。看别人演示 demo 的时候确实是这样，但人家 5 分钟之内不可能把每个细节都讲清楚。
...
装好之后输入`/fb-maker-skill @input/when-extract-from-skill.md`，Claude 就把文章转好了。
...
几个来回之后，你就有了一个最小化的自动流程。你也可以按照这个流程把 Threads 加进去。然后你可以让 Claude 记住：下次我说要转化文章的时候，把两个版本同时转出来。

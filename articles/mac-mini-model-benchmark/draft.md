...
Claude 生成了一份仔细的计划，连多个模型之间的接力顺序都想好了。我让它把这份计划存成 markdown 文件，然后清空对话框，开始测试。

其实我不知道它跑完所有测试用了多久。四个模型每个四张，有 16 张要生成。我后面去理发了，回来的时候它已经完成了，还有一份报告：
...
在机器人的图上，我只能看出精细程度，所以我完全信任 Claude 的评分。这次有些不同，人物和动作看一眼就能分出好坏。

这两组测试下来，我知道 Z-Image-Turbo 是最后的选择，哪怕会慢一点。
